...
flexibleSearchService.search("select {pk} from {Product as p} where {p:name[en]:ol} IS NULL and {p:code}= 'CFFH17F1TW' and {p:catalogVersion} in ('8796224127577')").result.each {
